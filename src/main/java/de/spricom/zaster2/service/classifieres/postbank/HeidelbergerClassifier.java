...
@Component
public class HeidelbergerClassifier implements PostbankClassifier {

    @Override
    public String getName() {
        return "Heidelberger BU";
    }
    ...
    public boolean matches(PostbankGiroEntity entity) {
        return entity.getPartnerName().equals("Heidelberger Lebensversicherung AG");
    }
}
