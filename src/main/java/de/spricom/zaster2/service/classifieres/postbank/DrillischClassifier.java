...
@Component
public class DrillischClassifier implements PostbankClassifier {
    @Override
    public String getName() {
        return "Drillisch Online GmbH";
    }

    @Override
    public ClassificationCategory getCategory() {
        return ClassificationCategory.TILO;
    }

    @Override
    public boolean matches(PostbankGiroEntity entity) {
        return entity.getPartnerName().startsWith("Drillisch Online");
    }
}
